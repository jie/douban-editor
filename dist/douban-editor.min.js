...
var _btnIcons, _TipAfter;

var _react = __webpack_require__(0);

var _react2 = _interopRequireDefault(_react);

var _octicons = __webpack_require__(4);
...
var btnIcons = (_btnIcons = {
  bold: _react2.default.createElement('i', { className: 'fa fa-bold', 'aria-hidden': 'true' }),
  italic: _react2.default.createElement('i', { className: 'fa fa-italic', 'aria-hidden': 'true' }),
  underline: _react2.default.createElement('i', { className: 'fa fa-underline', 'aria-hidden': 'true' }),
  header: _react2.default.createElement('i', { className: 'fa fa-header', 'aria-hidden': 'true' }),
  blockquote: _react2.default.createElement('i', { className: 'fa fa-quote-left', 'aria-hidden': 'true' }),
  code: _react2.default.createElement('i', { className: 'fa fa-code', 'aria-hidden': 'true' }),
  ol: _react2.default.createElement('i', { className: 'fa fa-list-ol', 'aria-hidden': 'true' }),
  ul: _react2.default.createElement('i', { className: 'fa fa-list', 'aria-hidden': 'true' })
}, _defineProperty(_btnIcons, 'header', _react2.default.createElement('i', { className: 'fa fa-header', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'link', _react2.default.createElement('i', { className: 'fa fa-link', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'picture', _react2.default.createElement('i', { className: 'fa fa-picture-o', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'video', _react2.default.createElement('i', { className: 'fa fa-video-camera', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'times', _react2.default.createElement('i', { className: 'fa fa-times', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'commenting', _react2.default.createElement('i', { className: 'fa fa-commenting-o', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'share', _react2.default.createElement('i', { className: 'fa fa-share-alt', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'upload', _react2.default.createElement('i', { className: 'fa fa-upload', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'book', _react2.default.createElement('i', { className: 'fa fa-book', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'text', _react2.default.createElement('i', { className: 'fa fa-file-text-o', 'aria-hidden': 'true' })), _defineProperty(_btnIcons, 'save', _react2.default.createElement('i', { className: 'fa fa-floppy-o', 'aria-hidden': 'true' })), _btnIcons);
...
var TipAfter = (_TipAfter = {
  ...
  width: "5px",
  height: "5px"
}, _defineProperty(_TipAfter, 'width', 0), _defineProperty(_TipAfter, 'height', 0), _defineProperty(_TipAfter, 'borderLeft', "4px solid rgba(0, 0, 0, 0)"), _defineProperty(_TipAfter, 'borderRight', "4px solid rgba(0, 0, 0, 0)"), _defineProperty(_TipAfter, 'borderTop', "5px solid rgba(0,0,0,0.8)"), _TipAfter);
    ...
    value: function getTip() {
      if (this.state.showTip) {
        return _react2.default.createElement(
          'div',
          { style: TipStyle },
          this.props.tip || this.props.label,
          _react2.default.createElement('span', { style: TipAfter })
        );
      }
    }
  }, {
...
var InlineButton = function (_BaseButton) {
  _inherits(InlineButton, _BaseButton);

  function InlineButton(props) {
    _classCallCheck(this, InlineButton);

    var _this2 = _possibleConstructorReturn(this, (InlineButton.__proto__ || Object.getPrototypeOf(InlineButton)).call(this, props));
  ...
  _createClass(InlineButton, [{
    ...
    value: function render() {
      var className = this.props.buttonClass;
...
var CommandButton = function (_BaseButton2) {
  _inherits(CommandButton, _BaseButton2);

  function CommandButton() {
    _classCallCheck(this, CommandButton);

    return _possibleConstructorReturn(this, (CommandButton.__proto__ || Object.getPrototypeOf(CommandButton)).apply(this, arguments));
  }
...
var UploadButton = function (_BaseButton3) {
  _inherits(UploadButton, _BaseButton3);
  ...
  _createClass(UploadButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'span',
        { className: this.props.buttonClass },
        _react2.default.createElement('input', { type: 'file', accept: 'image/*', multiple: true, onChange: this.onFileChange.bind(this) }),
        this.getIcon()
      );
    }
  }]);
...
module.exports = {
  DoubanEditor: _editor.DoubanEditor
};
...
Object.keys(data).forEach(function (key) {
  ...
  var htmlAttributes = function htmlAttributes(icon, options) {
    var attributes = [];
...
var MediaBlock = function (_React$Component) {
    ...
    function MediaBlock(props) {
        ...
        return _possibleConstructorReturn(this, (MediaBlock.__proto__ || Object.getPrototypeOf(MediaBlock)).call(this, props));
    }
    ...
    _createClass(MediaBlock, [{
        ...
        value: function render() {
            ...
            var media = void 0;
            if (type === 'audio') {
                media = _react2.default.createElement('audio', { controls: true, src: src, style: styles.media });
            } else if (type === 'image') {
                media = _react2.default.createElement('img', { src: src, style: styles.media });
            } else if (type === 'video') {
                media = _react2.default.createElement('video', { controls: true, src: src, style: styles.media });
            }
            return media;
        }
    }]);
...
var Controlbar = function (_React$Component) {
  ...
  _createClass(Controlbar, [{
    key: 'getInlineButton',
    value: function getInlineButton(type) {
      var isActive = false;
      ...
      return _react2.default.createElement(_button.InlineButton, {
        key: type.label,
        active: isActive,
        label: type.label,
        tip: type.tip,
    ...
    key: 'getBlockButton',
    value: function getBlockButton(type) {
    ...
    key: 'getUploadButton',
    value: function getUploadButton(type) {
      var editorState = this.props.editorState;

      var selection = editorState.getSelection();
      var blockType = editorState.getCurrentContent().getBlockForKey(selection.getStartKey()).getType();

      return _react2.default.createElement(_button.UploadButton, {
        key: type.label,
        active: type.style === blockType,
        label: type.label,
        tip: type.tip,
    ...
    value: function getButtons() {
      var buttons = [];
      for (var i = 0; i < this.props.buttonItems.length; i++) {
        var item = this.props.buttonItems[i];
        if (item.type == 'sep') {
          buttons.push(_react2.default.createElement('div', { className: 'db-sep', key: i }));
          ...
          buttons.push(_react2.default.createElement(_button.CommandButton, {
            key: i,
            label: item.label,
...
module.exports = {
    BaseButton: _button.BaseButton,
    InlineButton: _button.InlineButton,
    UploadButton: _button.UploadButton,
    CommandButton: _button.CommandButton,
    BUTTON_ITEMS: _controlbar.BUTTON_ITEMS,
    Controlbar: _controlbar.Controlbar,
    blockRenderMap: _wrapper.blockRenderMap,
    MediaBlock: _block.MediaBlock,
    extendedBlockRenderMap: _wrapper.extendedBlockRenderMap,
    mediaBlockRenderer: _block.mediaBlockRenderer
};
...
var BaseWrapper = function (_React$Component) {
  ...
  function BaseWrapper(props) {
    ...
    return _possibleConstructorReturn(this, (BaseWrapper.__proto__ || Object.getPrototypeOf(BaseWrapper)).call(this, props));
  }

  return BaseWrapper;
}(_react2.default.Component);

var CodeWrapper = function (_BaseWrapper) {
  _inherits(CodeWrapper, _BaseWrapper);

  function CodeWrapper() {
    _classCallCheck(this, CodeWrapper);

    return _possibleConstructorReturn(this, (CodeWrapper.__proto__ || Object.getPrototypeOf(CodeWrapper)).apply(this, arguments));
  }

  _createClass(CodeWrapper, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'pre',
...
var BlockquoteWrapper = function (_BaseWrapper2) {
  _inherits(BlockquoteWrapper, _BaseWrapper2);

  function BlockquoteWrapper() {
    _classCallCheck(this, BlockquoteWrapper);

    return _possibleConstructorReturn(this, (BlockquoteWrapper.__proto__ || Object.getPrototypeOf(BlockquoteWrapper)).apply(this, arguments));
  }

  _createClass(BlockquoteWrapper, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'blockquote',
...
var AtomicWrapper = function (_BaseWrapper3) {
  _inherits(AtomicWrapper, _BaseWrapper3);

  function AtomicWrapper() {
    _classCallCheck(this, AtomicWrapper);

    return _possibleConstructorReturn(this, (AtomicWrapper.__proto__ || Object.getPrototypeOf(AtomicWrapper)).apply(this, arguments));
  }

  _createClass(AtomicWrapper, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'figure',
...
var blockRenderMap = _immutable2.default.Map({
  'code-block': {
    wrapper: _react2.default.createElement(CodeWrapper, null)
  },
  blockquote: {
    wrapper: _react2.default.createElement(BlockquoteWrapper, null)
  },
  atomic: {
    wrapper: _react2.default.createElement(AtomicWrapper, null)
  }
});
...
var DoubanEditor = function (_React$Component) {
  _inherits(DoubanEditor, _React$Component);

  function DoubanEditor(props) {
    _classCallCheck(this, DoubanEditor);

    var _this = _possibleConstructorReturn(this, (DoubanEditor.__proto__ || Object.getPrototypeOf(DoubanEditor)).call(this, props));

    _this.addImage = function (pictures) {
      _this._confirmPictureMedia(pictures);
    };
    ...
    _this.toggleUploadType = function (type) {
      return _this._toggleUploadType(type);
    };
  ...
  _createClass(DoubanEditor, [{
    ...
    key: '_toggleUploadType',
    value: function _toggleUploadType(blockType) {
      this.onChange(_draftJs.RichUtils.toggleBlockType(this.state.editorState, blockType));
    }
  }, {
    ...
    key: '_pictureAppendCallback',
    value: function _pictureAppendCallback(blockType, pictures) {
      this.onChange(_draftJs.RichUtils.toggleBlockType(this.state.editorState, blockType));
    }
  }, {
    ...
    value: function _promptForMedia(type) {
      ...
      this.setState({
        ...
        setTimeout(function () {
          _this2.refs.url.focus();
        }, 0);
      });
    }
  }, {
    key: '_confirmPictureMedia',
    value: function _confirmPictureMedia(pictures) {
      var _this3 = this;
      ...
      pictures.map(function (pic) {
        ...
        var _contentState = contentState.createEntity('image', 'IMMUTABLE', {
          src: pic.thumb,
          file: pic
        });
        _this3.setState({
          editorState: _draftJs.AtomicBlockUtils.insertAtomicBlock(editorState, _contentState.getLastCreatedEntityKey(), pic.thumb)
        }, function () {
          setTimeout(function () {
            return _this3.focus();
          }, 0);
    ...
    value: function getEditor() {
      ...
      return _react2.default.createElement(_draftJs.Editor, {
        spellCheck: false,
        editorState: editorState,
        blockRendererFn: _components.mediaBlockRenderer,
        blockStyleFn: myBlockStyleFn,
        blockRenderMap: _components.extendedBlockRenderMap,
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'title' },
          _react2.default.createElement('input', { type: 'text', placeholder: this.props.titlePlaceholder || '', dir: 'auto', value: this.state.title, onChange: this.handleTitleChange })
        ),
        _react2.default.createElement(_components.Controlbar, {
          toggleInlineStyle: this.toggleInlineStyle,
          toggleBlockType: this.toggleBlockType,
          buttonItems: _components.BUTTON_ITEMS,
...
/***/ })
/******/ ]);
//# sourceMappingURL=douban-editor.min.js.map